...
## TODO
* Реализовать движение по истории через объект Linked List, на это потребуется 1 день. Сейчас реализовано через объект window.history, но не создан обработчик нажатия на кнопку "Back" браузера + есть отличия в работе на разных движках.  
